...
import { CheckCircle2, AlertTriangle, X, ImagePlus } from "lucide-react";
import "./Support.css";
    ...
    <div className="page support-page">
      ...
      <form className="support-form" onSubmit={handleSubmit}>
        {(listingId || listingTitle || sellerName) && (
          ...
          >
            <strong>Reporting listing:</strong>
            <div style={{ marginTop: "8px", fontSize: "0.92rem" }}>
              <div>ID: {listingId || "N/A"}</div>
              <div>Title: {listingTitle || "N/A"}</div>
              <div>Seller: {sellerName || "N/A"}</div>
            </div>
          </div>
        )}
        ...
        <div className="form-group">
          ...
          <select
            ...
            onChange={(e) => {
              ...
              setErrors((er) => ({ ...er, reason: null }));
            }}
          >
            {REASONS.map((r) => (
              <option key={r} value={r === REASONS[0] ? "" : r}>
                {r}
              </option>
            ))}
          </select>
        ...
        <div className="form-group">
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            <span className="char-count" style={{ marginLeft: "auto" }}>
              {form.details.length}/700
            </span>
          </div>
        </div>
        ...
        <div className="form-group">
          ...
          {form.preview ? (
            ...
            <div className="upload-zone small" onClick={() => fileRef.current.click()}>
      ...
      <div className="support-faq">
        ...
        {[
          [
            ...
            "Most reports are reviewed within 24 hours. Complex cases may take up to 5 business days.",
          ],
          [
            "Will the seller know I reported them?",
            "No. All reports are anonymous. We never disclose who filed a report.",
          ],
          [
            "Can I report a buyer?",
            "Yes. Use the same form and select 'Seller harassment' or 'Other' and provide details.",
          ],
        ].map(([q, a]) => (
